...
namespace KRINT.Application.Command.TableRow
{
    ...
    public class UpdateTableRowCommandHandler(KrintDbContext db, ISecretsVaultService vault, IInnerSchemaServiceResolver resolver) : ICommandHandler<UpdateTableRowCommand>
    {
