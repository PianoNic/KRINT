...
namespace KRINT.Application.Queries.InnerDatabase
{
    public record ListInnerDatabasesQuery(Guid InstanceId) : IQuery<IReadOnlyList<string>>;

    public class ListInnerDatabasesQueryHandler(KrintDbContext db, ISecretsVaultService vault, IInnerDatabaseServiceResolver resolver) : IQueryHandler<ListInnerDatabasesQuery, IReadOnlyList<string>>
    {
